...
public class BackgroundAudioData : ScriptableObject
{
    ...
    public Sound BackgroundMusicForest;
    public Sound BackgroundMusicBeach;
    public Sound BackgroundMusicMountain;
    ...
    public Sound BackgroundMusicBadEnd;
    public Sound BackgroundMusicGoodEnd;
